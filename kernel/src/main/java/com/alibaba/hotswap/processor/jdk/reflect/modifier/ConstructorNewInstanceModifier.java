 ...
 */
public class ConstructorNewInstanceModifier extends BaseMethodAdapter {

    public ConstructorNewInstanceModifier(MethodVisitor mv, int access, String name, String desc){
