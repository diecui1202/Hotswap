 ...
 */
public class GetXFieldsFilterModifier extends BaseMethodAdapter {

    public GetXFieldsFilterModifier(MethodVisitor mv, int access, String name, String desc, String className){
